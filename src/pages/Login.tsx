  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        <h2 className="text-2xl font-semibold text-center mb-6">Account Login</h2>
        ...
        <div className="text-center text-sm text-gray-500 mt-4 space-y-1">
          <p>
            Forgot <span className="text-blue-600 cursor-pointer">Username</span> / <span className="text-blue-600 cursor-pointer">Password</span>?
          </p>
          <p>
            Create an account?{" "}
